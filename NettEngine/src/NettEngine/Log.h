...
//Client log macros
#define NE_CORE_TRACE(...)      ::NettEngine::Log::GetClientLogger()->trace(__VA_ARGS__)
#define NE_CORE_INFO(...)       ::NettEngine::Log::GetClientLogger()->info(__VA_ARGS__)
#define NE_CORE_WARN(...)       ::NettEngine::Log::GetClientLogger()->warn(__VA_ARGS__)
#define NE_CORE_ERROR(...)      ::NettEngine::Log::GetClientLogger()->error(__VA_ARGS__)
#define NE_CORE_FATAL(...)      ::NettEngine::Log::GetClientLogger()->fatal(__VA_ARGS__)